...
The **Referral** feature in MedAX allows doctors to refer patients for additional medical services or consultations.
Referrals can be **internal** (within the same organization) or **external** (to another company or provider).
...
| **Referral Type** | Choose **Internal**  or **External** . |
...
- After editing, the referral letter can be printed and given to the patient
